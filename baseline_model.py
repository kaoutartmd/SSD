...
from ray.rllib.models.tf.recurrent_net import RecurrentTFModelV2
...
class BaselineModel(RecurrentTFModelV2):
    ...
    def action_logits(self):
        """
        returns the action logits from the latest forward pass.
        """
        return self._model_out

    def value_function(self):
        """
        returns the value function result from the latest forward pass.
        """
    ...
    def get_initial_state(self):
        """
        returns initial state of this model. This model only has LSTM state from the policy_model.
        """
